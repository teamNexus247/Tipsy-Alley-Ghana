      ...
      <div className="product-main">
        <div className="homepage" id='boba'>
          <div className="content">
            <h1 className="title">Our Sweet <br />Bubble Tale</h1>
            <p className="description">
              Indulge in the sweet, chewy goodness of our boba<br /> drinks, as we bring you a delightful selection crafted<br /> 
              with fresh and variant flavors to choose from.
            </p>
        ...
        <div className="product-head">
          <h1>BOBA FOR YOU</h1>
          <p>
            Enjoy a refreshing treat that is both fun and flavorful, perfect for any time of the day.
          </p>
        </div>
