      ...
      <div className="product-main">
        <div className="homepage" id='mocktail'>
          <div className="content">
            <h1 className="title">Discover <br/>Our Unique <br/>Mocktail</h1>
            <p className="description">
              Enjoy all the flavor with no alcohol with our mocktails,<br />carefully crafted to create a sophisticated and refreshing <br /> 
              alternative to traditional cocktail. Discover a new favorite<br />and sip away without compromise.
            </p>
        ...
        <div className="product-head">
          ...
          <p>
            Explore the perfect non-alcoholic beverage suitable for any occcasion. <br/> We dey for you!
          </p>
        </div>
